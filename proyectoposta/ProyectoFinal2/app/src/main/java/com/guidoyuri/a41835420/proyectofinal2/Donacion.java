...
//	Set option as Multiple Choice. So that user can able to select more the one option from list
    ...
    private void Donante()
    {
        ...
        SparseBooleanArray sparseBooleanArray = lView.getCheckedItemPositions();
        SparseBooleanArray sparseBooleanArray1 = lView2.getCheckedItemPositions();
        int estado=0;
        if (sparseBooleanArray.size()==0&&sparseBooleanArray1.size()==0)
        {
            ...
            if (sparseBooleanArray.size()!=0) {
                ...
                for (int i = 0; i < checked.size(); i++) {
                    ...
                    try {
                        ...
                        String url = "http://guidoyuri.hol.es/bd/AgregarDonacionCosaNecesitada.php";
                        ...
                        json.put("Usuario_NombreUsuario", usuario);
            ...
            if (sparseBooleanArray.size()!=0) {
                int cntChoice1 = lView2.getCount();
                ...
                for (int i = 0; i < checked1.size(); i++) {
                    ...
                    try {
                        ...
                        OkHttpClient client = new OkHttpClient();
                        String url = "http://guidoyuri.hol.es/bd/AgregarDonacionHabilidades.php";
                        JSONObject json = new JSONObject();
                        Calendar c = Calendar.getInstance();
                        System.out.println("Current time => " + c.getTime());
    ...
    private class EventosTask extends AsyncTask<String, Void, ArrayList<CosaNecesitada>> {
        ...
        protected void onPostExecute(ArrayList<CosaNecesitada> cosasnecesitadasResult) {
            ...
            if (!cosasnecesitadasResult.isEmpty()) {
                ...
                lView.setAdapter(new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_multiple_choice, lista));
    ...
    private class EventosTask1 extends AsyncTask<String, Void, ArrayList<Habilidad>> {
        ...
        protected void onPostExecute(ArrayList<Habilidad> habilidadesResult) {
            ...
            if (!habilidadesResult.isEmpty()) {
                ...
                lView2.setAdapter(new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_multiple_choice, listah));
                lView2.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
                lView2.setBackgroundColor(Color.BLACK);
